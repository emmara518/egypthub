  ...
  theme: {
    extend: {
      ...
      boxShadow: {
        ...
        'elevation-gold-1': 'var(--elevation-gold-1)',
        'elevation-gold-2': 'var(--elevation-gold-2)',
        'elevation-gold-glow': 'var(--elevation-gold-glow)',
        'elevation-inner': 'var(--elevation-inner)',
        'elevation-inner-gold': 'var(--elevation-inner-gold)',
      },
      backgroundImage: {
