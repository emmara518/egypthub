...
function SkeletonCard() {
  return (
    <div className="shrink-0 w-[240px] md:w-auto animate-pulse">
      <div className="rounded-2xl overflow-hidden mb-3 border border-white/[0.08] bg-[#0F1525]">
    ...
    <section className="bg-theme-bg py-8 md:py-14">
      <div className="w-full max-w-[1440px] mx-auto px-5 md:px-8">
        <div className="flex items-end justify-between mb-6 md:mb-10">
          ...
          <Link href="/experiences" className="hidden md:inline-flex items-center gap-2 px-5 py-2.5 rounded-xl bg-gradient-to-r from-[#D4A24C] to-[#C89A3D] text-theme-bg text-sm font-bold font-english shrink-0 shadow-[0_4px_15px_rgba(212,162,76,0.25)] hover:shadow-[0_8px_30px_rgba(212,162,76,0.4)] transition-all">
            View All
                  ...
                  <div className="relative rounded-2xl overflow-hidden mb-3 border border-white/[0.08] group-hover:border-[#D4A24C]/30 transition-all duration-500 bg-[#0F1525]">
                    <div className="relative aspect-[4/5]">
                      ...
                      <div className="absolute top-3 left-3 pointer-events-none">
                        <span className="text-[8px] md:text-[9px] font-bold font-english tracking-[0.1em] text-[#D4A24C] bg-theme-bg/70 backdrop-blur-sm px-2.5 py-1 rounded-full border border-[#D4A24C]/20">{getTag(exp.category)}</span>
                      </div>
                    ...
                    <div className="p-4">
                      <div className="flex items-center gap-1.5 mb-2">
                        <div className="flex items-center gap-0.5">
                          ...
                          <span className="text-[11px] font-bold text-[#D4A24C] font-english">{exp.averageRating}</span>
                        </div>
                      ...
                      <div className="flex items-center justify-between">
                        <div className="flex items-baseline gap-1">
                          <span className="text-sm font-bold font-display text-[#D4A24C]">{formatPrice(exp.priceEgp)}</span>
                          <span className="text-[9px] text-white/30 font-english">/person</span>
                        </div>
                        <Link href="/booking" className="px-3 py-1.5 rounded-lg bg-gradient-to-r from-[#D4A24C] to-[#C89A3D] text-theme-bg text-[10px] font-bold font-english hover:shadow-[0_4px_12px_rgba(212,162,76,0.3)] transition-all">
                          احجز الآن
                        </Link>
                      </div>
                    </div>
        ...
        <div className="md:hidden mt-5">
          <Link href="/experiences" className="flex items-center gap-2 px-5 py-2.5 rounded-xl bg-gradient-to-r from-[#D4A24C] to-[#C89A3D] text-theme-bg text-sm font-bold font-english shadow-[0_4px_12px_rgba(212,162,76,0.2)]">
