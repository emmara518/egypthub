...
const paymentLogos = [
  ...
  { name: 'Mastercard', svg: (
    <svg viewBox="0 0 56 36" className="h-7 w-auto">
  ...
  { name: 'American Express', svg: (
    <svg viewBox="0 0 120 28" className="h-4 w-auto">
    ...
    <section className="py-16 bg-[#080C18]">
      <div className="max-w-[1440px] mx-auto px-6 lg:px-8">
        ...
        <div className="flex items-center gap-8 mb-12 flex-wrap justify-center">
          <span className="text-[11px] text-white/30 font-english whitespace-nowrap">Trusted by<br />the best</span>
        ...
        <div className="grid grid-cols-2 md:grid-cols-5 gap-6">
          {trustItems.map((item, i) => (
            ...
            >
              <div className="w-9 h-9 rounded-full bg-theme-gold/10 flex items-center justify-center mx-auto mb-3 group-hover:bg-theme-gold/15 transition-all duration-300">
                <item.icon className="w-4 h-4 text-theme-gold" />
              </div>
              <p className="text-[11px] font-bold mb-1">{item.title}</p>
