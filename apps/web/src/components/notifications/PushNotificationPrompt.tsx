  ...
  return (
    <AnimatePresence>
      {visible && (
        ...
        >
          <div className="bg-theme-surface border border-theme-gold/20 rounded-2xl p-5 shadow-[0_12px_40px_rgba(0,0,0,0.6)]">
            ...
            <div className="flex gap-2">
              <button onClick={handleAccept} className="flex-1 px-4 py-2.5 rounded-xl bg-gradient-gold text-dark-900 font-cairo font-bold text-sm">تفعيل</button>
