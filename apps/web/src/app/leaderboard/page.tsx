              ...
              return (
                ...
                >
                  <div className={`relative ${i === 0 ? 'mb-2' : 'mb-1'}`}>
                    ...
                    >
                      {i === 0 ? <svg width="18" height="18" viewBox="0 0 24 24" fill="none"><path d="M12 2l3.09 6.26L22 9.27l-5 4.87 1.18 6.88L12 17.77l-6.18 3.25L7 14.14 2 9.27l6.91-1.01L12 2z" fill="#D4A24C"/></svg> : i + 1}
                    </div>
                    {i === 0 && (
                      <motion.div
